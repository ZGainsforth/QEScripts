...
FileName = 'ld1ps.wfc'
# Orbitals to plot
OrbitalNames = ('3S', '4S', '3P', '3D', '3S_1', '4S_1', '3P_1', '3D_1')
Multiplicity = [2,    2,    6,    3,    2,    2,    6,    3]
# Plot settings
xlim = [0,2]
ylimlog = [1,1e5]
print(OrbitalNames)
...
plt.title(AtomName)
plt.legend()
plt.savefig('PlotIndividualWaveFuncRadialDistribution.png', dpi=300)
...
plt.savefig('PlotTotalRadialDistribution.png', dpi=300)
...
plt.savefig('PlotTotalChargeDensity.png', dpi=300)
