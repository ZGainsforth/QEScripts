...
if H_atomic == 1 then
    ...
    U_3d_3d_i = 0.0
    F2_3d_3d_i = 10.1273 * 0.8
    F4_3d_3d_i = 6.3541 * 0.8
    F0_3d_3d_i = U_3d_3d_i + 2 / 63 * F2_3d_3d_i + 2 / 63 * F4_3d_3d_i

    U_3d_3d_f = 0.0
    F2_3d_3d_f = 10.9741 * 0.8
    F4_3d_3d_f = 6.8879 * 0.8
    F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
    U_2p_3d_f = 0.0
    F2_2p_3d_f = 6.0565 * 0.8
    G1_2p_3d_f = 4.3899 * 0.8
    G3_2p_3d_f = 2.4956 * 0.8
    ...
    zeta_3d_i = 0.0267 * 1.0

    zeta_3d_f = 0.0362 * 1.0
    zeta_2p_f = 4.6499 * 1.0
...
function SaveSpectrum(G, suffix)
    ...
    G.Print({{'file', 'V3+_D4h_2p_XAS_' .. suffix .. '.spec'}})
end
